...
class User(AbstractUser):
    ...
    avatar = models.ImageField(upload_to='user/', verbose_name='Аватар', **NULLABLE, help_text='Загрузите аватар')
...
class Masseur(models.Model):
    ...
    speciality = models.ForeignKey(Speciality, on_delete=models.CASCADE, help_text='Укажите специализацию')
